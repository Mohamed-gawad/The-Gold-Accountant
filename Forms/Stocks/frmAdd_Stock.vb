Public Class frmAdd_Stock
    Dim Myconn As New Connection
    Dim fin As String
    Sub Filldrg()
        drg.Rows.Clear()
        Myconn.ExecQuery("SELECT * from [Stocks] order by Stock_ID")
        ...
        For i As Integer = 0 To Myconn.dt.Rows.Count - 1
            ...
            drg.Rows(i).Cells(1).Value = r("Stock_Name")
            drg.Rows(i).Cells(2).Value = r("Stock_ID")
        Next
    ...
    Sub Save_record()
        With Myconn
            ...
            .Addparam("@Stock_Name", txtName.Text)
            .ExecQuery("insert into  [Stocks] (Stock_ID,Stock_Name) values(@Stock_ID,@Stock_Name)")
    ...
    Private Sub frmAdd_Stock_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
            Label5.Left = 0
    ...
    Private Sub btnUpdat_Click(sender As Object, e As EventArgs) Handles btnUpdat.Click
        ...
        With Myconn
            ...
            .Addparam("@Stock_Name", txtName.Text)
            .Addparam("@Stock_ID", txtID.Text)
            .ExecQuery("Update  [Stocks]  set Stock_Name =@Stock_Name where Stock_ID =@Stock_ID")
            If Myconn.NoErrors(True) = False Then Exit Sub
        End With
    ...
    Private Sub btnDel_Click(sender As Object, e As EventArgs) Handles btnDel.Click
        ...
        With Myconn
            .Addparam("@Stock_ID", txtID.Text)
            .ExecQuery("delete from [Stocks] where Stock_ID = @Stock_ID ")
        End With
        If Myconn.NoErrors(True) = False Then Exit Sub
    ...
    Private Sub drg_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles drg.CellClick
        Myconn.ExecQuery("select * from [Stocks] where Stock_ID =" & drg.CurrentRow.Cells(2).Value)
        Dim r As DataRow = Myconn.dt.Rows(0)
        txtID.Text = r("Stock_ID").ToString
        txtName.Text = r("Stock_Name").ToString
    End Sub

    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        Try
            Dim rpt As New rpt_Stocks
